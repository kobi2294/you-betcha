...
export const DAL_COLLECTIONS = ['audits', 'groups', 'metadata', 'users', 'calculated-groups', 'calculated-group-match-scores'] as const;
...
export type CollectionType<T extends DalCollection> =
    ...
    : T extends 'calculated-group-match-scores' ? DbModel.CalculatedGroupMatchScore
    : unknown;
